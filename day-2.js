...
function day2Part3() {
  ...
  walletNumber = Number(wallet); 
  // 3. use a math expression with the > operator to say if the statements is true or false.
  messageParagraph.innerHTML = `The TV costs ${tvNumber} and you have ${walletNumber} in your bank. It is ${walletNumber > tvNumber} that you can buy the TV!`
}
...
function day2Part4() {
  ...
  // 1. Ask the user for data
  bank = prompt("Pssst, hey bud. How much you got for these rockets?"); 
  // 2. convert it to a number
  bankNumber = Number(bank);
  // 3. use a math expression with the > operator to say if the statements is true or false.
  messageParagraph.innerHTML = `These rockets cost ${rocketNumber} and you got ${bankNumber}, so it's ${bankNumber > rocketNumber} that you can afford these rockets!`
}
